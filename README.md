...
The database architecture is structured using MongoDB to handle flexible query and response formats. The core entities include:
* **User:** Base entity representing all system users, their credentials, and assigned system roles.
* **Query:** Tracks academic questions posted by students, categorized by subject and urgency.
* **Response:** Stores drafts generated by the AI models alongside the final answers approved by moderators.
* **Session:** Manages scheduled live academic support sessions and queues.
* **Badge/Points:** Tracks user engagement metrics to fuel the platform's gamification system.

## Conclusion & Key Takeaways
The SIBA Digital Academic Support Platform (SDASP) successfully demonstrates how modern cloud architecture, strict role-based access control, and intelligent AI orchestration can modernize traditional academic resources. By utilizing a hybrid AI + Human-in-the-loop validation layer, the system maximizes efficiency without sacrificing academic integrity or accuracy.